...
const situations = [
  ...
  { id: 'children', label: 'Has Children', icon: Baby },
  { id: 'employed', label: 'Currently Employed', icon: Briefcase },
];
    ...
    <div className="page-container max-w-3xl">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-base" style={{ color: 'var(--color-text-light)' }}>
          Generate a personalized document checklist based on your visa type and personal situation.
        </p>
      </div>
        ...
        <div className="card animate-fade-in-up">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold" style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-text)' }}>
              ...
              {category.shortName} Document Checklist
            </h2>
