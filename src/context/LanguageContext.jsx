...
const translations = {
  en: {
    ...
    vbShare: 'Share',
    vbShareAria: 'Share this visa bulletin',
    vbShareVia: 'Share via',
    vbShareOn: 'Share on',
    vbShareEmail: 'Email',
    vbShareEmailAria: 'Share by email',
    vbShareCopyLink: 'Copy Link',
    vbShareCopied: 'Link copied to clipboard',
    vbShareCopiedShort: 'Copied!',
    vbShareClose: 'Close share menu',
    vbFamilyBased: 'Family-Based',
    vbEmploymentBased: 'Employment-Based',
    vbFamilyShort: 'Family',
    vbEmploymentShort: 'Employment',
    vbFinalActionDates: 'Final Action Dates (Table A)',
    vbDatesForFiling: 'Dates for Filing (Table B)',
    vbFinalActionShort: 'Final Action (A)',
    vbFilingShort: 'Filing (B)',
    vbAdvanced: 'advanced',
  ...
  es: {
    ...
    vbShare: 'Compartir',
    vbShareAria: 'Compartir este boletín de visas',
    vbShareVia: 'Compartir vía',
    vbShareOn: 'Compartir en',
    vbShareEmail: 'Correo',
    vbShareEmailAria: 'Compartir por correo',
    vbShareCopyLink: 'Copiar enlace',
    vbShareCopied: 'Enlace copiado al portapapeles',
    vbShareCopiedShort: '¡Copiado!',
    vbShareClose: 'Cerrar menú de compartir',
    vbFamilyBased: 'Basada en Familia',
    vbEmploymentBased: 'Basada en Empleo',
    vbFamilyShort: 'Familia',
    vbEmploymentShort: 'Empleo',
    vbFinalActionDates: 'Fechas de Acción Final (Tabla A)',
    vbDatesForFiling: 'Fechas para Presentación (Tabla B)',
    vbFinalActionShort: 'Acción Final (A)',
    vbFilingShort: 'Presentación (B)',
