...
const translations = {
  en: {
    ...
    vbFinalActionDates: 'Final Action Dates',
    vbDatesForFiling: 'Dates for Filing',
    vbAdvanced: 'advanced',
  ...
  es: {
    ...
    vbFinalActionDates: 'Fechas de Acción Final',
    vbDatesForFiling: 'Fechas para Presentación',
